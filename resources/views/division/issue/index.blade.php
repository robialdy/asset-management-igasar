...
<div class="text-end mb-3">
    <a href="{{ route('division.issue.create', Auth::user()->division->name) }}" class="btn btn-primary">
        Tambah Issue
    </a>
</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle; white-space: nowrap;">
                                    ...
                                    <a href="{{ route('division.issue.edit', ['division' => Auth::user()->division->name, 'code_asset' => $issue->asset->code_asset]) }}" class="text-primary" style="display: inline-block; vertical-align: middle;">
